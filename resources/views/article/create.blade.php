...
@section('content')
  ...
  @endif
  <h1 class="my-5 text-center">@lang('Add Article')</h1>
  <form class="row g-3 m-5 justify-content-center" method="POST">
      ...
      <div class="col-5">
        ...
        <input type="text" name="article_title_en" class="form-control" id="article_title_en" value="{{ old('article_title_en') }}">
      </div>
      <div class="col-5">
        <label for="article_title_fr" class="form-label">@lang('Title in French')</label>
        <input type="text" name="article_title_fr" class="form-control" id="article_title_fr" value="{{ old('article_title_fr') }}">
      </div>
      <div class="col-5">
        <label for="article_content_en" class="form-label">@lang('Article in English')</label>
        <input type="text" name="article_content_en" class="form-control" id="article_content_en" value="{{ old('article_content_en') }}">
      </div>
      <div class="col-5">
